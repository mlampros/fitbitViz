...
* **asc_desc_linestring**: this parameter is related to the GPS data of the **3-dimensional** map especially if you keep track of your outdoor activities. There are **3 options**:
...
If you use the **fitbitViz** R package in your paper or research please cite `https://cran.r-project.org/web/packages/fitbitViz/citation.html`:
